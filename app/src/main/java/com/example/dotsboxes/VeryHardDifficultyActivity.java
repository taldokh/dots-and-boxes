...
public class VeryHardDifficultyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setCheckedItem(R.id.very_hard_menu_item);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.two_players_menu_item:
                        intent = new Intent(VeryHardDifficultyActivity.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                        break;
                    case R.id.easy_difficulty_menu_item:
                        intent = new Intent(VeryHardDifficultyActivity.this, EasyDifficultyActivity.class);
                        startActivity(intent);
                        finish();
                        break;
                    case R.id.normal_difficulty_menu_item:
                        intent = new Intent(VeryHardDifficultyActivity.this, NormalDifficultyActivity.class);
                        startActivity(intent);
                        finish();
                        break;
                    case R.id.hard_difficulty_menu_item:
                        intent = new Intent(VeryHardDifficultyActivity.this, HardDifficultyActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                        startActivity(intent);
                        finish();
                        break;
                    case R.id.settings_menu_item:
                        intent = new Intent(VeryHardDifficultyActivity.this, SettingsActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                        startActivity(intent);
                        finish();
                        break;
                    case R.id.normal_vs_hard_menu_item:
                        intent = new Intent(VeryHardDifficultyActivity.this, NormalVsHardActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                        startActivity(intent);
                        finish();
                        break;
    ...
    public void clickSound() {
        ...
        mediaPlayer = MediaPlayer.create(VeryHardDifficultyActivity.this, R.raw.touch2);
        mediaPlayer.start();
    ...
    public int negaMax(Board board, int depth){ // O(m^d + n^3)
        ...
        int move, val, best = Integer.MIN_VALUE;
