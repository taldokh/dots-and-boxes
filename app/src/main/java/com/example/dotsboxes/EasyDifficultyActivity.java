...
public class EasyDifficultyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setCheckedItem(R.id.easy_difficulty_menu_item);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.two_players_menu_item:
                        intent = new Intent(EasyDifficultyActivity.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                        break;
                    case R.id.normal_difficulty_menu_item:
                        intent = new Intent(EasyDifficultyActivity.this, NormalDifficultyActivity.class);
                        startActivity(intent);
                        finish();
                        break;
                    case R.id.hard_difficulty_menu_item:
                        intent = new Intent(EasyDifficultyActivity.this, HardDifficultyActivity.class);
                        startActivity(intent);
                        finish();
                        break;
                    case R.id.very_hard_menu_item:
                        intent = new Intent(EasyDifficultyActivity.this, VeryHardDifficultyActivity.class);
                        startActivity(intent);
                        finish();
                        break;
                    case R.id.settings_menu_item:
                        intent = new Intent(EasyDifficultyActivity.this, SettingsActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                        startActivity(intent);
                        finish();
                        break;
                    case R.id.normal_vs_hard_menu_item:
                        intent = new Intent(EasyDifficultyActivity.this, NormalVsHardActivity.class);
                        startActivity(intent);
                        finish();
                        break;
                }
        ...
        bluePointsTexts = findViewById(R.id.red_player_points_texts);
    ...
    public void clickSound() {
        ...
        mediaPlayer = MediaPlayer.create(EasyDifficultyActivity.this, R.raw.touch2);
        mediaPlayer.start();
    ...
    public void aiMove() {
        ...
        if(mainBoard.canConquer())
            mainBoard.fillAlmostFilledBoxes(null);
